...
export function TokenSelector({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1.5 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl z-50 w-full min-w-[180px] overflow-hidden max-h-[240px] overflow-y-auto">
          {tokens.map((token) => (
            <button
              key={token.address}
              onClick={() => {
